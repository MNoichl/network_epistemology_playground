...
# Heins rewiring
def create_hybrid_network(n_nodes: int, degree: int, p_rewiring: float):
    ...
    network_rewired = rewire_network(network, p_rewiring)
    return network_rewired


def rewire_network(network: nx.DiGraph, p_rewiring: float):
...
def randomized_barabasi_albert_graph(n_nodes,n_edges_to_add,randomization_probability):
    ...
    return randomize_network(G, randomization_probability)
