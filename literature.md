...
The epistemic value of modelling and simulations heavily relies on the empirical adequacy of these models and simulations (Weisberg, 2013; Ylikoski & Aydinonat, 2014; Bokulich, 2017; Frey and Šešelja, 2018, Frigg & Hartmann, 2020).[^*] From this perspective, the existing literature faces four interrelated challenges: 
